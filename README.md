...
publisher landing pages, DSpace 7 entity and Handle URLs, and uses a sequence
of resolution strategies to
...
- Accepts DOI, DOI URL, ISBN, arXiv ID/URL, publisher URL, DSpace 7 entity or
